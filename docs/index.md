...
If you use this package, cite the archived release. The concept DOI
below always resolves to the latest version:

> Ganglmair, B., and W. K. Robinson. patccatClaims: Product vs Process
> U.S. Patent Claim Classifier.
> <https://doi.org/10.5281/zenodo.22697822>

`CITATION.cff` in this repository carries the machine-readable version,
and GitHub’s “Cite this repository” link renders it.
